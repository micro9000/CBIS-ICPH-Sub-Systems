...
Public Class AdminAuthentication : Inherits SqlControl

    ' Use for user login
    Public Function IsAdminExists(ByVal username As String, ByVal password As String) As Boolean
        Try
            Dim selectAdminQuery As String = "SELECT * FROM AdminUsers WHERE (username = '" & username & "' AND password = '" & password & "')"
    ...
    Public Function GetAdminId(ByVal username As String, ByVal password As String) As Integer
        ...
        Try
            Dim getAdmindQuery As String = "SELECT id FROM AdminUsers WHERE (username = '" & username & "' AND password = '" & password & "')"
