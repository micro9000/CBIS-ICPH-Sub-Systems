...
Public Class StocksController : Inherits SqlControl
    ...
    Delegate Sub DisplayProducts(ByVal qty As Integer, ByVal curStockQty As Integer, ByVal lotNumber As String, ByVal brandName As String, ByVal genericName As String, ByVal category As String, ByVal classification As String, ByVal unitCost As Decimal, ByVal currentStocksQuantity As Integer, ByVal expirationDate As String)
    ...
    Public Sub GetAllProductsInProdCategory(ByVal prodCatID As Integer, ByRef displayProducts As DisplayProducts)
        ...
        Try
            Dim getThisProductQuery As String = "SELECT PharmacyStocks.quantity, PharmacyStocks.currentStocksQuantity, MedicinesStockBatch.lotNumber, Medicines.brandName, Medicines.genericName, MedicineCategory.category,MedicineClassification.classification, Medicines.unitCost,PharmacyStocks.currentStocksQuantity, MedicinesStockBatchItems.expirationDate " & _
