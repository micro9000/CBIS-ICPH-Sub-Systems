...
Public Class StocksController : Inherits SqlControl
    ...
    Delegate Sub DisplayProducts(ByVal qty As Integer, ByVal curStkQty As Integer, ByVal lotNumber As String, ByVal brandName As String, ByVal genericName As String, ByVal category As String, ByVal classification As String, ByVal unitCost As Decimal, ByVal currentStocksQuantity As Integer, ByVal expirationDate As String)
    ...
    Public Sub GetAllProductsInProdCategory(ByVal prodCatID As Integer, ByRef displayProducts As DisplayProducts)
        ...
        Try
            Dim getThisProductQuery As String = "SELECT ERPharmacyStocks.quantity, ERPharmacyStocks.currentStocksQuantity, ERPharmacyStocks. MedicinesStockBatch.lotNumber, Medicines.brandName, Medicines.genericName, MedicineCategory.category,MedicineClassification.classification, Medicines.unitCost,ERPharmacyStocks.currentStocksQuantity, MedicinesStockBatchItems.expirationDate " & _
            ...
            Try
                While (reader.Read())
                    displayProducts(reader("quantity"), reader("currentStocksQuantity"), reader("lotNumber"), reader("brandName"), reader("genericName"), reader("category"), reader("classification"), reader("unitCost"), reader("currentStocksQuantity"), reader("expirationDate"))
                End While
            Catch ex As Exception
                MessageBox.Show(ex.Message, "Error: 0x101 - Get All Product Categories (2)", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Finally
    ...
    Public Sub GetAllProducts(ByRef displayProducts As DisplayProducts, ByVal batchID As Integer)
        ...
        Try
            Dim getAllProducts As String = "SELECT ERPharmacyStocks.quantity, ERPharmacyStocks.currentStocksQuantity, MedicinesStockBatch.lotNumber, Medicines.brandName, Medicines.genericName, MedicineCategory.category,MedicineClassification.classification, Medicines.unitCost,ERPharmacyStocks.currentStocksQuantity, MedicinesStockBatchItems.expirationDate " & _
                                            "FROM Medicines,ERPharmacyStocks,MedicinesStockBatch,MedicinesStockBatchItems, MedicineCategory, MedicineClassification " & _
    ...
    Public Sub SearchProduct(ByVal prodBrandGernericName As String, ByVal batchId As Integer, ByRef displayProducts As DisplayProducts)
        Try
            Dim searchProductQuery As String = "SELECT ERPharmacyStocks.quantity, ERPharmacyStocks.currentStocksQuantity, MedicinesStockBatch.lotNumber, Medicines.brandName, Medicines.genericName, MedicineCategory.category,MedicineClassification.classification, Medicines.unitCost,ERPharmacyStocks.currentStocksQuantity, MedicinesStockBatchItems.expirationDate " & _
                                            "FROM Medicines,ERPharmacyStocks,MedicinesStockBatch,MedicinesStockBatchItems, MedicineCategory, MedicineClassification " & _
