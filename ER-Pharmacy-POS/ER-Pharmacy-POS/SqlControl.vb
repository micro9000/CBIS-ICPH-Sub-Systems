...
Public Class SqlControl
    ...
    'Protected Connection As New SqlConnection With {.ConnectionString = "Data Source=192.168.1.57,1433;Server=WORKSYSTEM;Database=cbis_icphDB;User ID=" & Environment.UserName & ";Password=;Trusted_Connection=True;"}
