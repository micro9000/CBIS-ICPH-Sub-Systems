...
Public Class AddStocksController : Inherits SqlControl
    ...
    Public Function InsertNewRequests(ByVal userID As Integer) As Boolean
        Try
            Dim insertNewRequestsQuery As String = "INSERT INTO ERPharmacyRequests(requestStatus, userID) VALUES('new requests', " & userID & ")"
    ...
    Public Function GetNewRequestsID(ByVal userID As Integer) As Integer
        Dim id As Integer
        Try
            Dim getNewRequestIDQuery As String = "SELECT TOP 1 id FROM ERPharmacyRequests WHERE userID=" & userID & " ORDER BY id DESC"
    ...
    Public Function GetNewRequestsStatus(ByVal userID As Integer) As String
        ...
        Try
            Dim getNewRequestIDQuery As String = "SELECT TOP 1 requestStatus FROM ERPharmacyRequests WHERE userID=" & userID & " ORDER BY id DESC"
    ...
    Public Function InsertNewRequestItems(ByVal medId As Integer, ByVal medQuantity As Integer, ByVal pharRequestsId As Integer) As Boolean
        Try
            Dim insertNewRequestItemQuery As String = "INSERT INTO ERPharmacyRequestsItems(medicineID, medQuantity, erpharmaRequestID) VALUES(" & medId & ", " & medQuantity & ", " & pharRequestsId & ")"
