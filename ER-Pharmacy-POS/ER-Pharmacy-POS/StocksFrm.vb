Public Class StocksFrm
    ...
    Public Sub DisplayProducts(ByVal qty As Integer, ByVal curStkQty As Integer, ByVal lotNumber As String, ByVal brandName As String, ByVal genericName As String, ByVal category As String, ByVal classification As String, ByVal unitCost As Decimal, ByVal currentStocksQuantity As Integer, ByVal expirationDate As String)
        ProductsDGV.ForeColor = Color.Black

        Dim medItems As New DataTable("PurchaseProductList")
        Try
            ProductsDGV.Rows.Add(qty, curStkQty, lotNumber, brandName, genericName, category, classification, unitCost, currentStocksQuantity, expirationDate)
